...
MTileLayerControl.prototype.attachEventHandlers = function() {
	var self = this.self;
	G.event.addDomListener(this.slider,'mousedown',function(ev){self.sliderMouseDown(ev,this)});
	G.event.addDomListener(this.slider,'mouseup',function(ev){self.sliderMouseUp(ev,this)});
	G.event.addDomListener(this.slider,'mousemove',function(ev){self.sliderMouseMove(ev,this)});

};

MTileLayerControl.prototype.sliderMouseDown = function(ev,slider) {
	ev = ev ? ev : event;
	slider.style.cursor = 'pointer';
...
MTileLayerControl.prototype.sliderMouseUp = function(ev,slider) {
	ev = ev ? ev : event;
	this.dragging = false;
...
MTileLayerControl.prototype.sliderMouseMove = function(ev,slider) {
	ev = ev ? ev : event;
	if (!this.dragging) {
		return;
	}
...
MTileLayerControl.prototype.setSlider = function() {
